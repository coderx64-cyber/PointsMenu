...
MenuStructure()
{
    ...
    self MenuOption("Buy Wonder Weapons", 1, "Buy Minigun", ::BuyWeapon, 1);
    self MenuOption("Buy Wonder Weapons", 2, "Buy Blundergat", ::BuyWeapon, 4);
    self MenuOption("Buy Wonder Weapons", 3, "Buy Vitriolic Withering", ::BuyWeapon, 5);
    if (is_weapon_included("raygun_mark2_zm"))
    {
        self MenuOption("Buy Wonder Weapons", 4, "Buy Ray Gun Mark 2", ::BuyWeapon, 2);
    }

    self MainMenu("Buy Equipments", "Weapons Menu");
    self MenuOption("Buy Equipments", 0, "Buy Claymore", ::BuyWeapon, 8);
    self MenuOption("Buy Equipments", 1, "Buy Tomahawk", ::BuyWeapon, 10);
    self MenuOption("Buy Equipments", 2, "Buy Upgraded Tomahawk", ::BuyWeapon, 11);

    self MainMenu("Buy Melee", "Weapons Menu");
    self MenuOption("Buy Melee", 0, "Buy Spoon", ::BuyMelee, 2);
    self MenuOption("Buy Melee", 1, "Buy Spork", ::BuyMelee, 3);
}
