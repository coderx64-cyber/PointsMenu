...
MenuStructure()
{
    ...
    PowerupOptionsPos++;
    self MenuOption("Powerup Menu", PowerupOptionsPos, "Buy Zombie Blood", ::BuyPowerup, 7);
    ...
    self MenuOption("Buy Equipments", 2, "Buy Beacon", ::BuyWeapon, 9);
