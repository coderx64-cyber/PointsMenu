...
MenuStructure()
{
    ...
    {
        self MenuOption("Buy Wonder Weapons", 1, "Buy Ray Gun Mark 2", ::BuyWeapon, 2);
    }

    self MainMenu("Buy Equipments", "Weapons Menu");
    self MenuOption("Buy Equipments", 0, "Buy Cymbal Monkey", ::BuyWeapon, 6);
    self MenuOption("Buy Equipments", 1, "Buy EMP Grenade", ::BuyWeapon, 7);
    if (is_weapon_included("claymore_zm"))
    {
        self MenuOption("Buy Equipments", 2, "Buy Claymore", ::BuyWeapon, 8);
    }

    self MainMenu("Buy Melee", "Weapons Menu");
    OptionPos2 = 0;
    bFirstMeleeLoaded = false;
    if (isDefined(level.zombie_melee_weapon_list["bowie_knife_zm"]))
    {
